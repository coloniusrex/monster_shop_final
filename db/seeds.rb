...
merchant_user = megan.users.create!(name: 'Megan', address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, email: 'merch@example.com', password: 'merchant', role: 'merchant_admin')

...
RSpec.describe 'As a merchtant employee on the dashboard, in the merchant statistics', type: :feature do
  before(:each) do
  ...
  it "I can see a list of items w/ placeholder image and urged to find a cusotm one, each item is a link to that items edit form" do
